...
<head>
  ...
  <title>SWINGING WORLD - Ecommerce Website</title>
</head>
      ...
      <div class="navigation container">
        ...
        <div class="menu">
          ...
          <ul class="nav-list">
            ...
            <li class="nav-item">
              <a href="./contactus/cont.php" class="nav-link scroll-link">Contact</a>
            </li>
            <li class="nav-item">
              <a href="./singup/login.php" class="nav-link scroll-link">login</a>
            </li>
            <li class="nav-item">
      ...
      <div class="product-center container">
        <div class="product">
          <div class="product-header">
            <img src="./images/pic2.jpg" href="product-details">
            <ul class="icons">
        ...
        <div class="product">
          <div class="product-header">
            <img src="./images/pic1.jpg" alt="product-details.html">
            <ul class="icons">
              <span><i class="bx bx-heart"></i></span>
              <span><i class="bx bx-shopping-bag"></i></span>
              <span><i class="bx bx-search"></i></span>
        ...
        <div class="product">
          <div class="product-header">
            <img src="./images/pic3.jpg" alt="product-details.html">
            <ul class="icons">
              <span><i class="bx bx-heart"></i></span>
              <span><i class="bx bx-shopping-bag"></i></span>
              <span><i class="bx bx-search"></i></span>
    ...
    <section class="section">
      <div class="testimonial-center container">
        <div class="testimonial">
          <span>&ldquo;</span>
          <p>
            Latest trends in Fashion. Free Shipping available* Choose from a vast selection of the best quality products. 100% Purchase protection. Easy Returns. Free Shipping* Huge Selection. 100% Purchase Protection. Pay On Delivery.
          </p>
          <div class="rating">
            <i class="bx bxs-star"></i>
            <i class="bx bxs-star"></i>
